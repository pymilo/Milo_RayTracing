...
fbr = 0.0           ## front blocker radius
rbr = 2.6              ## rear blocker radius
Sdist = -2000.0        ## cm
#offaxisAngle = 0.0     ## arcmin
offaxisAngles = np.arange(0.0,2.,0.1)     ## arcmin
...
for angle in offaxisAngles:
    ...
    save_rays(Rrays,filename='/Users/Kamilobu/Desktop/Developer/Milo_RayTracing/Laser_Alignment/X8/rays/rays_Angle_=_'+'{:.1f}'.format(angle)+'.csv')
