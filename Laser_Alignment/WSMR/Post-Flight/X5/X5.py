...
fbr = 2.8595             ## front blocker radius
rbr = 2.5669             ## rear blocker radius
Sdist = -1524.0        ## cm
#offaxisAngle = 0.0     ## arcmin
offaxisAngles = np.arange(0.0,10.0,1.0)     ## arcmin
...
for angle in offaxisAngles:
    ...
    save_rays(Rrays,filename='/Users/Kamilobu/Desktop/Developer/Milo_RayTracing/Laser_Alignment/WSMR/X5/rays/rays_Angle_=_'+'{:.1f}'.format(angle)+'.csv')
